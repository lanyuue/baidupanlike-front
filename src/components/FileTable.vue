<template>
  <div>
    ...
    >
      ...
      >
        <md-table-cell style="text-align:left" md-label="文件名" md-sort-by="name">{{ item.name }}</md-table-cell>
        <md-table-cell style="text-align:left" md-label="描述" md-sort-by="email">{{ item.email }}</md-table-cell>
        <md-table-cell style="text-align:left" md-label="大小" md-sort-by="gender">{{ item.gender }}</md-table-cell>
